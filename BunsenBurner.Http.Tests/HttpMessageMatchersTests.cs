...
public static class HttpMessageMatchersTests
{
    ...
    public static void Case1() =>
        HasMethod(HttpMethod.Delete).Invoke(Req.Delete.To("test")).Should().BeTrue();

    [Fact(DisplayName = "HasMethod does not match for the incorrect HTTP method")]
    public static void Case2() =>
        HasMethod(HttpMethod.Delete).Invoke(Req.Get.To("test")).Should().BeFalse();

    [Fact(DisplayName = "And can be used to combine matchers")]
    public static void Case3() =>
        HasMethod(HttpMethod.Delete)
            .And(HasHeader("test", "*"))
            .Invoke(Req.Delete.To("test").WithHeader("test", "1"))
            .Should()
            .BeTrue();
    ...
    public static void Case6() =>
        HasMethod(HttpMethod.Delete)
            .Or(HasHeader("test", "a?"))
            .Invoke(Req.Get.To("test1").WithHeader("test", "a2"))
            .Should()
            .BeTrue();
    ...
    public static void Case7() =>
        HasMethod(HttpMethod.Delete)
            .Or(HasHeader("test", "a?"))
            .Invoke(Req.Get.To("test1").WithHeader("test", "b2"))
            .Should()
            .BeFalse();
    ...
    public static void Case8() =>
        HasMethod(HttpMethod.Delete)
            .Or(HasHeader("test", "a?"))
            .Invoke(Req.Get.To("test1").WithHeader("test2", "a2"))
            .Should()
            .BeFalse();
    ...
    public static void Case9() =>
        HasBearerToken("abcd")
            .Invoke(Req.Get.To("some-endpoint").WithBearerToken("abcd"))
            .Should()
            .BeTrue();
