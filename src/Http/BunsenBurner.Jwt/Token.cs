...
public sealed record Token
{
    ...
    private Token(string signingKey, TimeSpan? lifetime = default)
    {
    ...
    public static Token New(string signingKey, TimeSpan? lifetime = default) =>
    ...
    public static Token? FromRaw(string rawToken)
    {
        ...
        var token = new Token(signingKey: string.Empty);
    ...
    private static void AddToTokenComponent<T>(TokenPartValues dictionary, string name, T value)
        where T : notnull
    {
